...
public abstract class BaseTest {
    ...
    static final String REGISTRATION_PASSWORD1 = "********";
    static final String REGISTRATION_PASSWORD2 = "********";

    static final String STABLE_CLIENT_EMAIL = "client-yop@yopmail.com";
    static final String STABLE_CLIENT_PASSWORD = "********";
    static final String STABLE_MANAGER_EMAIL = "man-yop@yopmail.com";
    static final String STABLE_MANAGER_PASSWORD = "********";
    static final String STABLE_PROVIDER_EMAIL = "prov-yop@yopmail.com";
    static final String STABLE_PROVIDER_PASSWORD = "********";
