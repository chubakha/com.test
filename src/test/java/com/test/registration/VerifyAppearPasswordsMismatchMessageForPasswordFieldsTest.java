...
public class VerifyAppearPasswordsMismatchMessageForPasswordFieldsTest extends PrepareRegistrationTestData {

    @Test
    void verifyAppearPasswordsMismatchMessageForPasswordFields(){
