...
public class VerifyAppearPasswordsMismatchMessageForPasswordFieldsWithEmptyPasswordFieldTest extends PrepareRegistrationTestData {

    @Test
    void verifyAppearPasswordsMismatchMessageForPasswordFieldsWithEmptyPasswordField(){
